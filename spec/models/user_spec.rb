...
it 'passwordが全角文字を含むと登録できない' do
 ...
 it “family_name_furiganaにカタカナ以外の文字が含まれていると登録できない" do
        @user.family_name_furigana = ‘あべ’
        @user.valid?
        expect(@user.errors.full_messages).to include(“Family_name_furigana is invalid")
      end

       it “first_name_furiganaにカタカナ以外の文字が含まれていると登録できない" do
        @user.first_name_furigana = ‘たかし’
        @user.valid?
        expect(@user.errors.full_messages).to include(“First_name_furigana is invalid")
      end
